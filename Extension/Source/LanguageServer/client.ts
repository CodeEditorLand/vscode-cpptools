...
const CppContextRequest: RequestType<void, ChatContextResult, void> =
	new RequestType<void, ChatContextResult, void>("cpptools/getChatContext");
...
export class DefaultClient implements Client {
	...
	public async getIncludes(
		...
		return DefaultClient.withLspCancellationHandling(
			() =>
				this.languageClient.sendRequest(IncludesRequest, params, token),
			token,
		);
	}
	...
	public async getChatContext(
		...
		return DefaultClient.withLspCancellationHandling(
			() =>
				this.languageClient.sendRequest(CppContextRequest, null, token),
			token,
		);
	}
