...
export function classOf(
	...
	return instance
		? typeof instance === "function" // is it a JavaScript function of some kind?
			? is.asyncConstructor(instance)
				? classOf(instance.class)
				: is.Constructor(instance)
					? (instance as Constructor) // is it really a constructor?
...
const builtIns = new Set(
	Object.keys(Object.getOwnPropertyDescriptors(Object.getPrototypeOf({}))),
);
...
export function members(obj: any): Members {
	...
	if (typeof obj === "object") {
		...
		do {
			...
			for (const [memberName, descriptor] of Object.entries(
				...
				if (
					...
					if (type === "function") {
						...
						result.methods.set(memberName, {
							hasNonWordCharacters: /\W/.test(
								obj[memberName]
									.toString()
									.replace(/^async\s+|\([\S\s]*/gm, "") ||
									memberName,
							),
