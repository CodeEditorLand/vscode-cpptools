...
export function first<TElement>(
	iterable:
		| Iterable<TElement>
		| undefined
		| Promise<Iterable<TElement> | undefined>,
	predicate: (element: TElement) => true | undefined = (e) => e as any,
): TElement | Promise<TElement | undefined> | undefined {
...
export function firstOrFail<TElement>(
	...
	predicateOrMessage:
		| string
		| Error
		| ((element: TElement) => true | undefined) = (e) => e as any,
	message?: string | Error,
): TElement | Promise<TElement> | never {
	let result: any;
