...
export type Callback<TOutput = unknown> = (
	event: EventData<TOutput>,
	...args: any[]
) =>
	| Promise<TOutput>
	| Promise<EventStatus>
...
export type Subscription<T extends Record<string, any> = Record<string, any>> =
	PickByType<T, Callback | string>;
